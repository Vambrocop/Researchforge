...
> spans ~239 analyses across ~36 method families (causal, regression, survival,
> spatial, panel/econometrics, time-series, multivariate, psychometrics,
> epidemiology, quality/SPC, nonparametric, machine learning, and more — see
...
The catalog holds ~239 analyses, grouped by methodology family. Highlights by
domain:
